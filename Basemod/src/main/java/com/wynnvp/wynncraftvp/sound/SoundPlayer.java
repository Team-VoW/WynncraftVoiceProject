...
public class SoundPlayer {
	...
	private boolean reportUnvoicedLine(String chatMessage) throws IOException {
		...
		URL urlObj = new URL("https://voicesofwynn.com/api/unvoiced-line-report/new?apiKey=" + apiKey);
		HttpURLConnection connection = (HttpURLConnection) urlObj.openConnection();
		connection.setRequestMethod("GET");
        connection.setRequestProperty("User-Agent", "VoicesOfWynnModClient");
		connection.setDoOutput(true);
		DataOutputStream outputStream = new DataOutputStream(connection.getOutputStream());
		String urlPostParameters = "npc=" + npcName + "&dialogue=" + dialogue + "&full=" + fullLine + "&x=" + CoordX + "&y=" + CoordY + "&z=" + CoordZ + "&apiKey=testing"; 
