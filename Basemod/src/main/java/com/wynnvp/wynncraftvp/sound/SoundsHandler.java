...
public class SoundsHandler {
    ...
    public void registerSounds() {
        ...
        addSound("[1/9] Guard: Finally, some backup! Help me out here, would ya?", "kingsrecruit-guard2-1", false);
        addSound("[2/9] Aledar: What happened, did you get attacked by the corrupt?", "kingsrecruit-aledar-26", false);
        addSound("[3/9] Guard: Not quite, recruit. I'm well-equipped for them. The issue is this cave-in.", "kingsrecruit-guard2-2", false);
        addSound("[4/9] Tasim: This isn't seriously the only way through, is it? What are we going to do?", "kingsrecruit-tasim-21", false);
        addSound("[5/9] Guard: If it wasn't for my injuries, I could just use my weapon to cast a spell on these boulders to get rid of them.", "kingsrecruit-guard2-3", false);
        addSound("[6/9] Guard: ...", "kingsrecruit-guard2-4", false);
        ...
        //Flight in distress
        addSound("[1/4] Airship Clerk: Good day, soldier! Will you be flying with us today?", "flightindistress-passengercontrollant-1", false);
        ...
        addSound("[1/4] Captain Ackbar: Hello again, did you find him?", "flightindistress-captainackbar-2", false);
