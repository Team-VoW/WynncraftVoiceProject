...
public class SoundsHandler {
    ...
    public void registerSounds() {
        ...
        addSound("[4/8] Honip: So, I've seen ya around town. Ya even went to the ocean to help that chicken guy!", "misadventureonthesea-honip-2", false);
        ...
        addSound("[1/3] Honip: There you are! Ready? Follow me, the boat's over here!", "misadventureonthesea-honip-6", false);
        addSound("[2/3] Honip: Look at this.. Magnificent! Much better than whatever the Seaskipper is using!", "misadventureonthesea-honip-7", false);
        addSound("[3/3] Honip: Well, what are you waiting for? Hop aboard!", "misadventureonthesea-honip-8", false);
        addSound("[1/2] Honip: Then it's settled, we're goin' on an adventure!", "misadventureonthesea-honip-9", false);
        addSound("[2/2] Honip: Buckle up, we got waves to catch.", "misadventureonthesea-honip-10", false);
        ...
        addSound("[4/7] Honip: They are a bit too head on, don't you think?", "misadventureonthesea-honip-14", false);
        addSound("[5/7] Honip: I'm trying to steer the ship but it's not budging...", "misadventureonthesea-honip-15", false);
        ...
        addSound("[1/3] Honip: So, there's quite a few skeletons in there, and we never bothered throwin' em out!", "misadventureonthesea-honip-19", false);
        ...
        addSound("[1/7] Honip: I don't know where that creature came from, but thanks to you it's gone.", "misadventureonthesea-honip-32", false);
        addSound("[2/7] Honip: I've got somethin' else for you to tackle. It's about... the rats.", "misadventureonthesea-honip-33", false);
        addSound("[3/7] Honip: Come to the hold, I'll explain on the way.", "misadventureonthesea-honip-34", false);
        addSound("[4/7] Honip: I think we have quite a hellish problem on our hands.", "misadventureonthesea-honip-35", false);
        addSound("[5/7] Honip: I'm not sure what ya'll find there, but these are NOT normal rats.", "misadventureonthesea-honip-36", false);
        addSound("[6/7] Honip: So please, get in there... and kill everything, alright?", "misadventureonthesea-honip-37", false);
        addSound("[7/7] Honip: I've got faith in ya. Here goes nothin'!", "misadventureonthesea-honip-38", false);
        addSound("[1/4] Honip: Hey there! Ya bringin' me good news?", "misadventureonthesea-honip-39", false);
        addSound("[2/4] Honip: You took care of these damn thieving rodents? A... colossal rat you say?", "misadventureonthesea-honip-40", false);
        addSound("[3/4] Honip: Nicely done, I knew I could count on ya! C'mere, take these!", "misadventureonthesea-honip-41", false);
        addSound("[4/4] Honip: Anyway, for now, you can go rest and do whatever you want!", "misadventureonthesea-honip-42", false);
        addSound("[1/4] Honip: What. ", "misadventureonthesea-honip-43", false);
        addSound("[2/4] Honip: Well... That's a twist.", "misadventureonthesea-honip-44", false);
        addSound("[3/4] Honip: I expected you to do somethin', soldier, not him!", "misadventureonthesea-honip-45", false);
        addSound("[4/4] Honip: Anyways, come talk to me", "misadventureonthesea-honip-46", false);
        addSound("[1/7] Honip: I have another task for you. its about the rats.", "misadventureonthesea-honip-47", false);
        addSound("[2/7] Honip: See, I really don't think we have your usual type of problems.", "misadventureonthesea-honip-48", false);
        addSound("[4/7] Honip: We sometimes hear unusual load footsteps, along with some really eerie squeaking...", "misadventureonthesea-honip-49", false);
        addSound("[5/7] Honip: That's why we're not too fond of goin' in... But our gunpowder there! We need it, as pirates!", "misadventureonthesea-honip-50", false);
        addSound("[6/7] Honip: So, I need you to get in there... and try to kill everything, alright?", "misadventureonthesea-honip-51", false);
        addSound("[7/7] Honip: Here goes nothing, Snoo, ya stay there!", "misadventureonthesea-honip-52", false);
        addSound("[3/4] Honip: That sounds absolutely terrifying! And ya did that alone! You know what, her', take these.", "misadventureonthesea-honip-53", false);
        addSound("[1/5] Honip: Just cast one of your fancy spells!", "misadventureonthesea-honip-54", false);
        addSound("[2/5] Honip: That was... Phew... That was something.", "misadventureonthesea-honip-55", false);
        addSound("[3/5] Honip: Now, for an even bigger surprise...", "misadventureonthesea-honip-56", false);
        addSound("[4/5] Honip: What the hell soldier?? What don't you get in the \"\"soldier\"\" part of your job?", "misadventureonthesea-honip-57", false);
        addSound("[5/5] Honip: Come, let's figure some things out.", "misadventureonthesea-honip-58", false);
        addSound("[1/7] Honip: You've been a massive disappointment, y'know?", "misadventureonthesea-honip-59", false);
        addSound("[2/7] Honip: But you can still redeem yourself.", "misadventureonthesea-honip-60", false);
        addSound("[3/7] Honip: Follow me, I'll explain on the way.", "misadventureonthesea-honip-61", false);
        addSound("[4/7] Honip: I mentioned a rat problem earlier... It's, uh, not a small one.", "misadventureonthesea-honip-62", false);
        addSound("[5/7] Honip: We've got gunpowder to retrieve, so you're the one who's gonna clear the hold.", "misadventureonthesea-honip-63", false);
        addSound("[6/7] Honip: So get in there... and try to kill everything, alright?", "misadventureonthesea-honip-64", false);
        addSound("[7/7] Honip: Don't be as bad as earlier. You're a soldier.", "misadventureonthesea-honip-65", false);
        addSound("[3/4] Honip: Well, shiver me timbers! You did redeem yourself soldier!", "misadventureonthesea-honip-66", false);
        addSound("[1/4] Honip: ...Seth? Have ya seen the soldier?", "misadventureonthesea-honip-67", false);
        addSound("[2/4] Seth: No, but they did a great job in the hold! Some gunpowder went missing though.", "misadventureonthesea-seth-3", false);
        ...
        addSound("[1/7] Seaskipper Captain: Well... We're headed for Selchar, the heart of the ocean! Which is safer than wherever you were, heh!", "misadventureonthesea-seaskippercaptain-2", false);
