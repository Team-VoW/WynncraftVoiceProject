...
public class SoundsHandler {
    ...
    public void registerSounds() {
        ...
        addSound("[4/6] Worker: GwaaAAAAAH!!", "rol1wormholes-worker-1", true);
        ...
        addSound("[1/8] Lari: ...Haven’t we met? I have witnessed your presence in Gavel more than once.", "rol1wormholes-lari-1", false);
        addSound("[2/8] Lari: I am Lari. I might have greeted you properly before if I were not so busy, which reminds me. You have a reason to be here, yes?", "rol1wormholes-lari-2", false);
        addSound("[3/8] Lari: Hm...I believe I know what you have found, by your description. That dead skin too, is proof enough, I would say.", "rol1wormholes-lari-3", false);
        addSound("[4/8] Lari: The creature which shed that skin is known as a Grootslang. Though large, they are rather peaceful. Gentle giants, I believe the saying is?", "rol1wormholes-lari-4", false);
        addSound("[5/8] Lari: This horrid Decay...it affects their habitats underground. They are seeking shelter closer to the surface. I have been trying to scrub the Decay without success...", "rol1wormholes-lari-5", false);
        addSound("[6/8] Lari: Wait... More holes appeared just today? There...there were deaths?! W-where, when?!", "rol1wormholes-lari-6", false);
        addSound("[7/8] Lari: No, no...! I refuse to be responsible for any more deaths... Human, tell me your name, please. ", "rol1wormholes-lari-7", false);
        ...
        addSound("[1/1] Lari: Take the lead.", "rol1wormholes-lari-16", true);
