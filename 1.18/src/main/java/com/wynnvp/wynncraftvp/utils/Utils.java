...
public class Utils {
    ...
    public static void sendMessage(String text) {
        MinecraftClient.getInstance().inGameHud.getChatHud().addMessage(Text.of(text));
    }

    //Checks if the players is even on wynn
    public static boolean inWynn() {
        try {
            return MinecraftClient.getInstance().getCurrentServerEntry().address.toLowerCase().contains("wynncraft");
